...
\begin{itemize}
    \item \textbf{Evaluación:} Cada semana se evaluará el progreso individual dentro de los grupos. Se valorará la funcionalidad, el cumplimiento de los estándares de código (Type Hinting, Docstrings) y el manejo de errores.
    ...
    \item \textbf{Colaboración:} El curso cuenta con \textbf{13 estudiantes divididos en 4 grupos de trabajo especializado}. Cada grupo es responsable de un módulo del sistema, fomentando la arquitectura desacoplada y el desarrollo en paralelo.
...
El proyecto se desarrolla de forma modular. Aunque los temas se presentan cronológicamente, los grupos trabajarán en paralelo según la asignación técnica.
...
\begin{itemize}
    ...
    \item \textbf{Estudiante 3:} Escáner de puertos \textbf{UDP} y manejo de respuestas ICMP Port Unreachable.
    \item \textbf{Estudiante 4:} Implementación de \textbf{Banner Grabbing} inicial para identificación de servicios tras el escaneo.
\end{itemize}
